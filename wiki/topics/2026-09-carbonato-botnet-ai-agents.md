---
slug: carbonato-botnet-ai-agents
first_seen: 2026-09-24
tags: [봇넷, AI에이전트, Docker, 악성코드]
cves: []
---

**Carbonato** 봇넷이 노출된 **Docker 데몬**을 표적으로 **Hermes Agent AI 프레임워크**를 설치해 호스트를 장악하는 공격을 수행 중이다. AI 에이전트 프레임워크를 멀웨어 인프라로 악용하는 사례다.
