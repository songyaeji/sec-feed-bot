---
slug: tuxbot-v3-llm-iot-botnet
first_seen: 2026-07-15
tags: [보트넷, AI, IoT]
cves: []
---

보안 연구진이 **TuxBot v3 Evolution**이라 명명된 IoT 보트넷 프레임워크를 분석 공개했다. 해당 보트넷은 **LLM**의 지원을 받아 개발된 흔적을 보여주며, 크로스 컴파일 바이너리와 C2 아키텍처 분석을 통해 LLM 기반 개발의 허점(안전성 고지문 포함 등)이 드러났다.
...
- [[mycelium-ai-botnet-framework]] — Mycelium 크로스플랫폼 AI 보트넷 프레임워크
