---
slug: clop-windchill-extortion
first_seen: 2026-07-24
tags: [랜섬웨어, 데이터협박, PTC제품, 기업표적]
cves: []
---

Clop 랜섬웨어 집단이 인터넷 노출 PTC Windchill 및 FlexPLM 인스턴스를 표적하는 데이터 협박 캠페인을 개시했다. 인터넷 접근성 있는 설정 오류 있는 기업 서비스를 침해해 민감 설계 데이터를 탈취하고 협박 구조화한다.
