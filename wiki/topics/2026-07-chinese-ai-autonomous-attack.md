---
slug: chinese-ai-autonomous-attack
first_seen: 2026-07-30
tags: [AI에이전트, 자동화공격, 취약점스캔]
cves: []
---

중국 위협 행위자가 **AI 모델 기반 자동화** 스캔과 수동 익스플로잇을 결합한 공격 캠페인을 운영 중이다. 7개 취약점을 대상으로 자동화된 취약점 탐색과 자동 익스플로잇을 수행하며, 대규모 봇넷 구축 시도가 확인됐다.
