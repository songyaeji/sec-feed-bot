---
slug: threat-actors-ai-platforms-attack-surface
first_seen: 2026-09-11
tags: [AI보안, 공급망공격, 악성콘텐츠호스팅]
cves: []
---

위협 행위자들이 **Claude Artifacts**, AI 검색 중독, **ClickFix** 등 신뢰할 수 있는 AI 플랫폼을 악성 콘텐츠 호스팅 및 사용자 기만의 공격 표면으로 악용하는 신규 캠페인이 확인됐다. Huntress의 분석에 따르면 공격자들은 AI 기반 유명 플랫폼의 신뢰도를 이용해 검색 결과 중독, 피싱 이메일 링크, 멀웨어 배포를 조직화하고 있다.
