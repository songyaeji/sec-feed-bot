---
slug: ted-backdoor-haproxy
first_seen: 2026-09-04
tags: [악성코드, 로드밸런서악용, 트래픽가로채기, 한국표적]
cves: []
---

**Ted** 백도어가 피해자 조직의 **HAProxy 로드밸런서 바이너리에 직접 컴파일되어** 설치된 사건이 적발되었다. 웹 트래픽 가로채기와 선택적 피해자 대상 페이지 변조를 실행한 정교한 공급망 변조 사례다.
